 ...
 */
export function validateSearchDocsRequest(request) {
    const errors = [];
 ...
 */
export function validateGetDocSummaryRequest(request) {
    const errors = [];
 ...
 */
export function validateBatchDocSummaryRequest(request) {
    const errors = [];
