    ...
    const configItems = React.useMemo(() => {
        if (currentFolders && Array.isArray(currentFolders) && currentFolders.length > 0) {
            ...
            const testChildren = [
                ...
                new TextListItem("", <Text color="gray">Language Configuration: Select the primary language of your content for optimal search results</Text>, false, undefined, 'truncate'),
                ...
                new TextListItem("", <Text color="gray">Content Type Selection: Choose the type of content you'll be indexing to optimize processing</Text>, false, undefined, 'truncate'),
                new SelectionListItem(
                    "·",
                ...
                new TextListItem("", <Text color="gray">Folder Selection: Choose the folder containing the files you want to index and search</Text>, false, undefined, 'truncate'),
                ...
                new TextListItem("", <Text color="gray">Embedding Model: Select the AI model that will process your content for semantic search</Text>, false, undefined, 'truncate'),
                new SelectionListItem(
                    "·",
